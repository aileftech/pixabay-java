...
//			add("-models");
	...
	public PixabayScraper(String apiKey, String keyword) {
		this.apiKey = apiKey;
...
//	}
	...
	public List<PixabayVideo> getBestVideos() throws IOException {
		...
		String url = "https://pixabay.com/api/videos/?key=" + apiKey + "&q=$QUERY$&category=buildings";
	...
	public List<VideoImage> getBestImages() throws ClientProtocolException, IOException {
		String url = "https://pixabay.com/api/?key=" + apiKey + "&q=$QUERY$&orientation=horizontal&image_type=photo&min_width=800&per_page=100&page=";
